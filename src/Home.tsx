...
const Home = (props: HomeProps) => {
  ...
  return (
    <main>
      <MainContainer>
        <WalletContainer className="line">
          <Logo>
          ...
          <Menu>
            ...
            <li>
              <a
                className="fnt"
                href="https://discord.com/invite/rabp"
                target="_blank"
                rel="noopener noreferrer"
              >
                Discord
            ...
            <li>
              <a
                className="fnt"
                href="https://twitter.com/rabpnft?t=mSbAQTxAH3oI7e6SFaYgSw&s=09"
                target="_blank"
                rel="noopener noreferrer"
              >
                Twitter
          ...
          <DesContainer>
            <NFT elevation={3}>
              ...
              <div>
                ...
                <Image
                className="gg"
                  src="https://media.discordapp.net/attachments/874259441384574976/1017030134152306749/unknown.png?width=617&height=618"
                  alt="NFT To Mint"
                />
              </div>
              <br />
              <div className="g2">
                ...
                <h2 className="k">Description</h2>
                <p className="rD">
                  Limited 500 NFTs that represent a token of remembrance. A
                  memento for the brave survivor who is still pursuing a meaning
                  of freedom.
                </p>
                <div className="price">
                  Price:{" "}
                  <Image
                    className="pi"
                    src="https://media.discordapp.net/attachments/1014489705963860008/1017088986826686464/TLS_Token2x.png"
                  />{" "}
                  1 TLS TOKEN
                </div>
